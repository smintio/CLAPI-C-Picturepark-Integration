...
namespace Client.Contracts.Picturepark
{
    ...
    [PictureparkDisplayPattern(DisplayPatternType.Name, TemplateEngine.DotLiquid, "{{data.smintIoCompoundAssetPart.usage | translate: language}}")]
    [PictureparkDisplayPattern(DisplayPatternType.List, TemplateEngine.DotLiquid, "{{data.smintIoCompoundAssetPart.usage | translate: language}}")]
    [PictureparkDisplayPattern(DisplayPatternType.Thumbnail, TemplateEngine.DotLiquid, "{{data.smintIoCompoundAssetPart.usage | translate: language}}")]
    [PictureparkDisplayPattern(DisplayPatternType.Detail, TemplateEngine.DotLiquid, "{{data.smintIoCompoundAssetPart.usage | translate: language}}")]
    ...
    public class SmintIoCompoundAssetPart : Relation
    {
