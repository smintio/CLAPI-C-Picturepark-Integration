...
namespace Client.Contracts.Picturepark
{
    ...
    [PictureparkDisplayPattern(DisplayPatternType.Name, TemplateEngine.DotLiquid, @"{{data.smintIoContentProvider.name | translate}}")]
    public class SmintIoContentProvider : ReferenceObject
    {
        [PictureparkRequired]
